...
declare module 'vscode' {
	...
	export interface SemanticTokensProvider {
		 ...
		 * *NOTE 2*: All edits in `SemanticTokensEdits` contain indices in the old integers array, so they all refer to the previous result state.so they all refer to the previous result state.
		 */
