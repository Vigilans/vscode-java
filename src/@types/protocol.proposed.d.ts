...
declare module 'vscode-languageclient' {
    ...
    export namespace SemanticHighlightingNotification {
        export const type = 'textDocument/semanticHighlighting';
    }
    /**
    ...
    type ClientCapabilities = protocol.ClientCapabilities & SemanticHighlightingClientCapabilities;

    type ServerCapabilities = protocol.ServerCapabilities & SemanticHighlightingServerCapabilities;
}
